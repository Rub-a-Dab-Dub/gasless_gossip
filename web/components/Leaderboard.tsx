  ...
  return (
    <div className="md:pb-0 pb-52">
      <div className="grid grid-cols-3 gap-4 mb-8 md:hidden">
        <button className="py-4 flex-1 bg-dark-teal text-[#14F1D9] rounded-full font-semibold hover:from-[#0f5f57] hover:to-[#0c4a42] transition-all">
          Today
        </button>
        <button className="py-4 border border-dark-teal bg-transparent text-grey-100 rounded-full font-semibold hover:text-white transition-all">
          Week
        </button>
        <button className="py-4 border border-dark-teal bg-transparent text-grey-100 rounded-full font-semibold hover:text-white transition-all">
          Month
      ...
      <section className="glass-effect p-6 rounded-3xl w-fit">
            ...
            >
              ...
              <div
                className={`bg-gradient-to-br ${getPodiumColor(
                  entry.rank
                )} rounded-3xl flex flex-col justify-between relative overflow-hidden`}
                style={{
                  backgroundImage: `url(/checker.png)`,
                }}
              >
                <div
                  className={`h-fit mt-18 bg-gradient-to-br ${getPodiumColor(
                    entry.rank
                  )} rounded-3xl`}
                >
                  {/* XP Bar */}
                  <div className="relative z-10 px-4 py-6">
                    <div
                      className={`bg-black/30 backdrop-blur-sm rounded-full px-6 border-4 ${getBorderColor(
                        entry.rank
                      )} text-center`}
                    >
        ...
        <div className="md:flex items-center justify-center gap-4 hidden mb-8 px-24">
          <button className="px-32 py-4 flex-1 bg-dark-teal text-[#14F1D9] rounded-full font-semibold hover:from-[#0f5f57] hover:to-[#0c4a42] transition-all">
            Today
          </button>
          <button className="px-12 py-4 border border-dark-teal bg-transparent text-grey-100 rounded-full font-semibold hover:text-white transition-all">
            Week
          </button>
          <button className="px-12 py-4 border border-dark-teal bg-transparent text-grey-100 rounded-full font-semibold hover:text-white transition-all">
            Month
