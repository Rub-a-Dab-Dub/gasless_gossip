      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <DialogPanel className="w-full max-w-2xl bg-dark-900 rounded-3xl shadow-2xl overflow-hidden border border-[#14F1D9]/30">
          <div className="p-12">
            ...
            <section className="p-4 small-glass-effect rounded-4xl">
              ...
              <div className="flex justify-center mb-12">
                <div className="bg-white rounded-full relative">
                  ...
                  <div
                    className="w-54 h-54 rounded-3xl"
                    style={{
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#6366f1] to-[#8b5cf6] flex items-center justify-center shadow-xl">
                        <svg
                          viewBox="0 0 256 417"
            ...
            <div className="">
              {/* Domain Name */}
              <div className="text-center px-4 py-3 mt-3 rounded-bl-lg rounded-br-lg rounded-tl-3xl rounded-tr-3xl border border-dark-teal small-glass-effect">
                <p className="text-xs text-light-grey tracking-wider mb-2">
                  domain name
                </p>
                <div className="flex items-center justify-center gap-2">
                  <span className="text-sm font-semibold text-dark-white">
              ...
              {/* Account Address */}
              <div className="text-center px-4 py-3 mt-3 rounded-tl-lg rounded-tr-lg rounded-bl-2xl rounded-br-2xl border border-dark-teal small-glass-effect">
                <p className="text-xs text-light-grey tracking-wider mb-2">
                  account address
                </p>
                <div className="flex items-center justify-center gap-2">
