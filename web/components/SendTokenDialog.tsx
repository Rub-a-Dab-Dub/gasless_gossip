...
export default function SendTokenDialog({
  ...
  return (
    <>
      <TokenReceivedDialog
        isOpen={isTokenSentDialogOpen}
        onClose={() => setIsTokenSentDialog(false)}
      />
                  ...
                  <div className="rounded-t-4xl border-1 border-dark-teal">
                    ...
                    <div className="flex items-start justify-between px-5 py-3 border-b border-dark-teal">
                      ...
                      <div className="text-right">
                        <p className="text-sm text-light-grey mb-1">
                          Your Balance:
                        </p>
                      ...
                      >
                        <div className="relative">
                          <div className="inline-flex rounded-full outline-hidden">
                            <ListboxButton className="inline-flex items-center gap-x-1.5 rounded-full border-light-grey px-3 py-2 text-dark-white border-1 border-y-1">
                              {selectedToken.logo && (
                                <selectedToken.logo className="w-5 h-5" />
                              )}
                  ...
                  <div className="grid grid-cols-3 py-3 px-6 divide-x divide-dark-teal pb-32 md:pb-0">
                    <div className="flex items-center justify-between w-full  md:pr-20 pr-4">
                      ...
                      <div className="place-items-center text-white text-center space-y-0.5">
                        <button className="flex flex-col items-center bg-white/5 p-2 text-light-grey rounded-full text-gray-400">
                          <File size={20} />
                        </button>
                    ...
                    <div className="place-items-center text-light-teal text-center space-y-0.5">
                      <button className="flex flex-col items-center rounded-full bg-white/5 p-2 gap-2 transition-colors">
                        <Wallet size={15} />
                      </button>
