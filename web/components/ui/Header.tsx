...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 sm:border-b border-[#181E1D] z-100 overflow-hidden">
        ...
        <nav className="hidden lg:flex flex items-center gap-16">
          {navigation.map((item) => (
            <div className="text-center" key={item.name}>
              ...
              >
                <item.icon
                  className={`aspect-square w-auto h-13 p-3 text-light-grey ${
                    item.href === pathname ? 'btn-glass-effect text-light-teal' : 'hover:text-light-grey'
                  }`}
                />
