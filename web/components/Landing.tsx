    ...
    <div className="overflow-hidden">
      ...
      >
        <div className="relative flex lg:flex-row flex-col items-center px-6 min-h-screen">
          ...
          <div className="flex items-center md:flex-row flex-col md:space-x-28 w-full mx-auto">
            ...
            <div
              ...
              <div className="">
                <div
                  className="text-2xl bg-[#1C1E22] rounded-full w-20 h-20 flex items-center justify-center font-medium text-white mb-2">
                  19.4k
                </div>
            ...
            <div className="flex-1 pr-8">
              ...
              <p className="text-lg lg:text-xl text-[#A3A9A6] mb-8 max-w-[450px] leading-relaxed font-fredoka">
                Your gossip just got an upgrade. Chat, earn, and gift your way through the blockchain’s most rewarding
                social playground.
              </p>
              <Link
                href="/dashboard"
          ...
          <div
            className="hidden md:flex mx-auto mt-16 md:flex max-w-2xl sm:mt-24 lg:mt-0 lg:mr-0 lg:ml-10 lg:max-w-none lg:flex-none xl:ml-32">
          ...
          <div
            className="-order-1 flex md:hidden mb-14 mx-auto md:mt-16 md:flex max-w-2xl sm:mt-24 lg:mt-0 lg:mr-0 lg:ml-10 lg:max-w-none lg:flex-none xl:ml-32">
            <div className="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
              <div className="-m-10">
                <Image
                  width="500"
        ...
        <div className="hidden md:block absolute right-[26rem] bottom-34 w-54 space-y-4 mx-auto">
          ...
          <p className="text-light-grey text-sm">Make someone smile. Drop tokens or NFTs into chats to celebrate,
            reward
            friends, or just</p>
        </div>
      </div>
      ...
      <div className="px-6 md:hidden flex">
        <div
          ...
          <div className="">
            <div
              className="text-2xl mx-auto bg-[#1C1E22] rounded-full w-20 h-20 flex items-center justify-center font-medium text-white mb-2">
              19.4k
            </div>
            <div className="text-sm text-[#A3A9A6] uppercase text-center tracking-wide">
              Users
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className=" text-[#A3A9A6] leading-[30px] font-fredoka">
                Gasless Gossip is not just another Web3 chat app. It’s where gossip meets tokens, secrets meet
                collectibles,
                and every message pushes you closer to leveling up. We’re turning social interaction into a game — fun,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="h-full">
              <div className="blur-effect rounded-3xl flex flex-col items-center justify-center gap-2 h-full">
                <svg width="154" height="310" viewBox="0 0 154 310" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                  ...
                  <path
                    ...
                    fill="#F1F7F6"/>
                  <ellipse cx="76.9996" cy="304.523" rx="55.6364" ry="5.46429" fill="#1B1E23"/>
                </svg>
            ...
            <ul className="space-y-4">
              <li className="bg-[#16191E] backdrop-blur-sm rounded-3xl p-6 border border-[#1B1E23]">
                <div className="flex items-center space-x-10 mb-3">
                  <button type="button" className="rounded-full bg-[#202226] p-2.5 text-white shadow-xs">
                    <svg width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <defs>
                        <linearGradient id="paint0_linear_1965_2208" x1="12.4838" y1="2.75611" x2="13.1382" y2="21.4947"
                  ...
                  <div className="space-y-3">
                    <h3 className="text-xl font-semibold text-white font-fredoka">Seamless Collaboration</h3>
                    <p className="text-light-grey font-fredoka">Connect with others effortlessly in real time. Host
                      rooms, share ideas, and build experiences together without friction.</p>
                  </div>
                </div>
              </li>
                ...
                <div className="flex items-center space-x-10 mb-3">
                  <button type="button" className="rounded-full bg-[#202226] p-2.5 text-white shadow-xs">
                    <svg width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <defs>
                        <linearGradient id="paint0_linear_1965_7790" x1="12.5366" y1="4.25465" x2="13.0862" y2="19.9951"
                                        gradientUnits="userSpaceOnUse">
                          <stop stopColor="#14F1D9"/>
                          <stop offset="1" stopColor="#A0F9F1"/>
                        </linearGradient>
                  ...
                  <div className="space-y-3">
                    <h3 className="text-xl font-semibold text-white font-fredoka">Reward System</h3>
                    <p className="text-light-grey font-fredoka">Earn tokens as you engage, create, and grow within the
                      community.
                      Your contributions have value.</p>
                  </div>
                </div>
              </li>
                ...
                <div className="flex items-center space-x-10 mb-3">
                  <button type="button" className="rounded-full bg-[#202226] p-2.5 text-white shadow-xs">
                    <svg width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <defs>
                        <linearGradient id="paint0_linear_1965_7816" x1="12.4845" y1="2.75543" x2="13.1388" y2="21.4931"
                                        gradientUnits="userSpaceOnUse">
                          <stop stopColor="#14F1D9"/>
                          <stop offset="1" stopColor="#A0F9F1"/>
                        </linearGradient>
                  ...
                  <div className="space-y-3">
                    <h3 className="text-xl font-semibold text-white font-fredoka">Creative Freedom</h3>
                    <p className="text-light-grey font-fredoka">Design your space, set your rules, and bring your ideas
                      to life.
                      You control how your room looks, feels, and functions.</p>
                  </div>
                </div>
              </li>
            </ul>
      ...
      <section className="py-20 px-6 lg:px-12 bg-black">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            ...
            <Disclosure as="div" className="bg-[#16191E] h-fit rounded-full border border-[#1B1E23] overflow-hidden">
              <DisclosureButton
                className="group flex w-full items-center justify-between px-10 py-6 hover:bg-[#1A1D22] transition-all">
                <span className="text-lg font-fredoka text-dark-white group-data-open:text-teal-300">
                  Do I Need A Crypto Wallet To Get Started?
                </span>
                <ChevronDown
                  className="size-6 group-data-open:text-teal-300 transition-transform duration-200 group-data-[open]:rotate-180"/>
              </DisclosureButton>

              <DisclosurePanel className="px-10 py-6 pt-0 text-[#A3A9A6] leading-relaxed border-t border-[#1B1E23]/50">
                Yes. You'll Need A Wallet To Receive Tokens And Manage Gated Room Access.
              </DisclosurePanel>
            </Disclosure>
      ...
      <footer
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center gap-8">
          ...
          <div className="flex items-center gap-10">
            ...
            <a
              ...
              <div
                className="w-16 h-16 rounded-full bg-[#171A1A] flex items-center justify-center">
        ...
        <div className="w-full mt-14 flex items-center justify-between text-[12px] text-white/40">
          ...
          <div className="flex items-center gap-3">
            <a href="#" className="hover:text-white/70 text-light-grey transition-colors">
              privacy policy
            </a>
            <span>•</span>
            <a href="#" className="hover:text-white/70 text-light-grey transition-colors">
