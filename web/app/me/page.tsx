...
export default function Me() {
  return (
    <>
      ...
      <div className="max-w-7xl pt-32 mx-auto px-4 py-8 text-white">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-12 gap-8">
          ...
          <div className="flex items-center gap-6">
            <div>
              ...
              <div className="text-sm text-center text-dark-white mt-2">
                username
              </div>
            </div>
            ...
            <div>
              <div className="flex gap-6 mb-3">
                <div>
                  <div className="text-sm text-tertiary uppercase tracking-wide mb-1">
                    Posts
                  </div>
          ...
          <div className="flex flex-col gap-3 w-full lg:w-64">
            ...
            <button className="px-6 py-3 bg-[#1A1D22] text-gray-300 rounded-full hover:bg-[#1A1D22]/70 transition-colors font-medium">
              Edit Profile
            </button>
          </div>
        </div>
        ...
        <TabGroup>
          <TabList className="flex justify-center text-center gap-8 mb-6 border-b border-dark-teal">
            <Tab className="pb-2 data-selected:text-dark-white text-light-grey data-selected:border-b data-selected:border-teal-300 w-full flex justify-center">
              Posts
            </Tab>
            <Tab className="pb-2 data-selected:text-dark-white text-light-grey data-selected:border-b data-selected:border-teal-300 w-full flex justify-center">
              Rooms
      ...
      <button className="fixed bottom-8 right-8 w-14 h-14 bg-emerald-400 rounded-full flex items-center justify-center shadow-lg hover:bg-emerald-500 transition-colors">
        <svg
