...
const HeroSection = () => {
  return (
    <div className="flex flex-col-reverse gap-32 xs:gap-56 md:gap-24  lg:gap-60 md:flex-row mt-2 md:mt-16 md:justify-center lg:justify-center md:items-center w-full ">
