...
exports.PredictionsModule = PredictionsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([prediction_entity_1.Prediction, prediction_vote_entity_1.PredictionVote, room_entity_1.Room, user_entity_1.User]),
        ],
        controllers: [predictions_controller_1.PredictionsController],
        providers: [predictions_service_1.PredictionsService, stellar_service_1.StellarService],
