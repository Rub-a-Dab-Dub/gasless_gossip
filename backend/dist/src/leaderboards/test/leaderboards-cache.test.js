...
describe('LeaderboardsService Cache', () => {
    ...
    beforeEach(async () => {
        ...
        const module = await testing_1.Test.createTestingModule({
            providers: [
                ...
                {
                    provide: (0, typeorm_1.getRepositoryToken)(level_entity_1.Level),
        ...
        service = module.get(leaderboards_service_1.LeaderboardsService);
    });
    describe('getLeaderboard', () => {
        ...
        it('should fetch from database and cache when cache miss', async () => {
            ...
            expect(mockCacheManager.set).toHaveBeenCalledWith('leaderboard:10', expect.any(Array), 300000);
        });
    });
    describe('getUserRank', () => {
        ...
        it('should fetch from database and cache when cache miss', async () => {
            ...
            mockRepository.findOne.mockResolvedValue(mockUserLevel);
            ...
            const result = await service.getUserRank('user1');
            expect(result).toBe(5);
            expect(mockCacheManager.set).toHaveBeenCalledWith('user_rank:user1', 5, 300000);
        });
    });
...
//# sourceMappingURL=leaderboards-cache.test.js.map