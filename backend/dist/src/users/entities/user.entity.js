...
__decorate([
    (0, typeorm_1.Column)({ name: 'stellar_account_id', unique: true, nullable: true }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.OneToMany)(() => reputation_entity_1.Reputation, (reputation) => reputation.user),
    __metadata("design:type", Array)
], User.prototype, "reputations", void 0);
__decorate([
