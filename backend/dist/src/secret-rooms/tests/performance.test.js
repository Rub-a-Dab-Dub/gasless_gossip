...
describe('SecretRoomsService Performance Tests', () => {
    let service;
    let mockSecretRoomRepo;
    let mockRoomInvitationRepo;
    let mockRoomMemberRepo;
    ...
    beforeEach(async () => {
        ...
        const module = await testing_1.Test.createTestingModule({
            providers: [
                secret_rooms_service_1.SecretRoomsService,
                {
                    provide: (0, typeorm_1.getRepositoryToken)(secret_room_entity_1.SecretRoom),
                    useValue: mockSecretRoomRepo,
                },
                {
                    provide: (0, typeorm_1.getRepositoryToken)(room_invitation_entity_1.RoomInvitation),
                    useValue: mockRoomInvitationRepo,
                },
                {
                    provide: (0, typeorm_1.getRepositoryToken)(room_member_entity_1.RoomMember),
        ...
        service = module.get(secret_rooms_service_1.SecretRoomsService);
    });
    describe('Performance with <200ms room creation', () => {
        ...
        it('should handle sustained room creation load', async () => {
            ...
            expect(minLatency).toBeLessThan(100);
    ...
    describe('Room access control performance', () => {
        ...
        it('should handle room member operations efficiently', async () => {
            ...
            mockSecretRoomRepo.findOne.mockResolvedValue(mockRoom);
            mockRoomMemberRepo.findOne.mockResolvedValue(null);
            mockRoomMemberRepo.create.mockReturnValue(mockMember);
            mockRoomMemberRepo.save.mockResolvedValue(mockMember);
            mockRoomMemberRepo.count.mockResolvedValue(6);
            ...
            expect(joinTime).toBeLessThan(150);
    ...
    describe('Database query performance', () => {
        ...
        it('should handle room statistics queries efficiently', async () => {
            ...
            mockRoomMemberRepo.count.mockResolvedValue(1000);
            const startTime = Date.now();
        ...
        it('should handle user room limit checks efficiently', async () => {
            mockSecretRoomRepo.count.mockResolvedValue(25);
            const startTime = Date.now();
            ...
            expect(limitTime).toBeLessThan(50);
