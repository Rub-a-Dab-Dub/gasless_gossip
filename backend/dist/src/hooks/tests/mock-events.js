...
class MockEventGenerator {
    ...
    static generateBatchEvents(count) {
        return Array.from({ length: count }, () => this.generateRandomEvent());
    }
}
exports.MockEventGenerator = MockEventGenerator;
