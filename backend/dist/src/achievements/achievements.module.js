...
exports.AchievementsModule = AchievementsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([achievement_entity_1.Achievement, user_entity_1.User])],
        controllers: [achievements_controller_1.AchievementsController],
        providers: [achievements_service_1.AchievementsService, stellar_service_1.StellarService],
