...
const activity_logs_controller_1 = require("./controllers/activity-logs.controller");
const activity_logs_service_1 = require("./services/activity-logs.service");
const activity_log_entity_1 = require("./entities/activity-log.entity");
const activity_analytics_listener_1 = require("./listeners/activity-analytics.listener");
...
exports.ActivityLogsModule = ActivityLogsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [activity_logs_service_1.ActivityLogsService, activity_analytics_listener_1.ActivityAnalyticsListener],
