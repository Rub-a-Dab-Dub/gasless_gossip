...
const challenge_progress_entity_1 = require("./entities/challenge-progress.entity");
...
exports.ChallengesModule = ChallengesModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([challenge_entity_1.Challenge, challenge_progress_entity_1.ChallengeProgress]),
